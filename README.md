...
Document AI Schema Setup Instructions:
...
11.	Click Save
12.	Click Manage Consumer Details to retrieve Consumer Key (aka Client Id) and Consumer Secret (aka Client Secret)
13.	Click Identity | OAuth and OpenID Connect Settings. If Allow OAuth Username-Password Flows is Enabled, then you must concatenate password with Security Tokens. If this applies to you, Head to my account’s Settings
-	Keep in mind, Username-Password Flow use is not recommended in production org. If disabled, things get a bit more complicated. Needs more research.
14.	Click My Personal Information | Reset My Security Token | Reset Security Token
15.	Check your email for your Security Token and concatenate is after your password
